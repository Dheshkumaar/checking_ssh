...
namespace TaskAPI.Controllers
{
    ...
    public class SBAccountsController : ControllerBase
    {
        ...
        public async Task<ActionResult<SBAccount>> PostSBAccount(SBAccount sBAccount)
        {
            ...
            return CreatedAtAction("GetSBAccount", new { id = sBAccount.AccountNumber }, sBAccount);
        }
        ...
        {
            return _context.SBAccounts.Any(e => e.AccountNumber == id);
        }
    }
}
